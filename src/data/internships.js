export const internships = [
  ...
  },
  {
    ...
    description: "Conducted end-to-end web application penetration tests, combining OSINT reconnaissance with targeted exploitation (SQLi, XSS) using tools like Burp Suite and sqlmap to deliver actionable remediation reports.",
    certificateUrl: "https://res.cloudinary.com/dx1zgcm3j/image/upload/v1773924403/Drop_Org_Intership_Cert_jxryox.jpg"
  }
];
