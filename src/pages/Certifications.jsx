...
import { X, Shield, Code, CheckCircle, ExternalLink } from 'lucide-react';
      ...
      <AnimatePresence>
        {selectedCert && (
          ...
          >
            ...
            >
              <div className="relative w-full aspect-video bg-black border-b border-cyber-cyan/30 flex justify-center items-center">
                <img src={selectedCert.image} alt={selectedCert.name} className="w-auto h-full max-w-full object-contain" />
                <button 
                  onClick={() => setSelectedCert(null)}
                  className="absolute top-4 right-4 bg-black/80 text-cyber-cyan border border-cyber-cyan p-2 rounded-full hover:bg-cyber-cyan hover:text-black transition-colors"
                >
                  <X size={20} />
                </button>
              </div>
