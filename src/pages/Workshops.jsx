...
export default function Workshops() {
  ...
  const categories = ['All', ...new Set(workshops.map(c => c.category))];
  const filteredCerts = filter === 'All' ? workshops : workshops.filter(c => c.category === filter);
            ...
            >
              ...
              <div className="w-full aspect-video overflow-hidden relative border-b border-cyber-cyan/50">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                  <span className="px-4 py-2 border border-cyber-cyan text-cyber-cyan font-orbitron text-sm rounded backdrop-blur-md">VIEW WORKSHOP</span>
                </div>
              </div>
